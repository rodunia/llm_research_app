...
def initialize_app():
    ...
    if anthropic_api_key:
        ...
        any_key = True
    if mistral_api_key:
        # Mistral client is instantiated when used
        any_key = True

    if not any_key:
        print("ERROR: No API keys found. Set OPENAI_API_KEY, GOOGLE_API_KEY, ANTHROPIC_API_KEY, or MISTRAL_API_KEY in your .env.")
        exit()
...
def setup_results_file(filename="results.csv"):
    """
